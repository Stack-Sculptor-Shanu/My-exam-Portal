...
import aboutimg from "../../Assets/reabout.svg";

const About = () => {
  return (
    <div className="flex flex-col min-h-screen md:flex-row items-center justify-between p-16 bg-gray-100 dark:bg-gray-900 rounded-xl shadow-lg transition-colors duration-300">
      {/* About Section */}
